...
版本：1.0.8-windows（以 `project.godot` 的 `application/config/version` 为准）
...
| 项目 | 当前结果 | 依据 |
|---|---|---|
| 应用/规则版本 | `1.0.8-windows` / config v3 / `aegis-windows-v1` | `project.godot`、`content/config/game_rules.json` |
